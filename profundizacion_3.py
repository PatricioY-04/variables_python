...
letra= input("Ingrese bu nombre completo: ")

print ("Hola", letra)
print ("En mayusculas es : ",letra.upper())
print ("En minusculas es: ",letra.lower())
print ("Con la primera en mayuscula es :",letra.capitalize())
