...
nombre_papa= input("Ingrese Nombre y Apellido de su Padre : ")
print("El nombre de su Padre es :", nombre_papa.upper())

nombre_p=nombre_papa.split(' ') #para separar 
print(nombre_p) #indica la lista separada 
print("El Nombre de su Padre es :",nombre_p[0])
print("El Apellido de su padre es: ",nombre_p[1])


nombre_mama=input("Ingrese Nombre y Apellido de su Madre : ")
print("Su Madre se llama :",nombre_mama.upper())

nombre_m=nombre_mama.split(' ') #para separar 
print(nombre_m) #indica la lista separada 
print("El Nombre de su Madre es :",nombre_m[0])
print("El Apellido de su Madre es: ",nombre_m[1])

print("__________________________________")
nombre_hijo=input("Ingrese únicamente sus dos nombres : ")
print ("Los nombres y apellidos del hijo por lo tanto son :",nombre_hijo +" "+ nombre_p[1] +" "+nombre_m[1])
