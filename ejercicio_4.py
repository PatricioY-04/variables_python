...
a_primera_letra = palabra_1[0]
print(a_primera_letra)
b_primera_letra = palabra_2[0]
print(b_primera_letra)
c_primera_letra = palabra_3[0]
print(c_primera_letra)
acronimo = a_primera_letra + b_primera_letra + c_primera_letra
print("El acrónimo quedaría : ", acronimo)